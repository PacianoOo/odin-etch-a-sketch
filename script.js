...
function show_grid() {
  ...
  grid_lines.classList.toggle('effect');
}

pix32.addEventListener('click', () =>{
  createGrid(32,32);
  pix32.classList.add('effect');
  pix64.classList.remove('effect');
  pix128.classList.remove('effect');
});

pix64.addEventListener('click', () =>{
  createGrid(64,64);
  pix32.classList.remove('effect');
  pix64.classList.add('effect');
  pix128.classList.remove('effect');
});
